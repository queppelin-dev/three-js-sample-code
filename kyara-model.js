const container = document.getElementById("kyara-banner");
...
function init() {
    ...
    materials = [
        new THREE.MeshPhongMaterial( { color: 0x1CBDF9, flatShading: true } ), // front
        new THREE.MeshPhongMaterial( { color: 0x1CBDF9 } ) // side
    ];
