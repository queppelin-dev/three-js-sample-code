...
function init() {
	...
	var onError = function (xhr) {
		// console.log(xhr);
		alert("This is an older version of FBX Model. Kindly upload a new version of the FBX Model.");
	};
	// model
	...
	// loader.load( 'phpserver/files/silly_dancing.fbx', function ( object ) {
	loader.load(objFile, function (object) {
		...
		// if(ext != 'phpserver/null'){
		// 	var textureLoader = new THREE.TextureLoader();
		// 	textureLoader.setCrossOrigin("anonymous");
		// 	textureLoader.load(imgFile, function (texture) {
		// 		// console.log(model);
